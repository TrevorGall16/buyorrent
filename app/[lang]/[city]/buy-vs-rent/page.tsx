...
const getNarrative = (city: CityData, lang: string) => {
  ...
  // 8-language x 3-template matrix
...
// Generate static params for all cities x languages (SSG)
...
export default async function CityBuyVsRentPage({ params }: PageProps) {
  ...
  const flagEmojis: Record<CountryCode, string> = {
    US: '\u{1F1FA}\u{1F1F8}', FR: '\u{1F1EB}\u{1F1F7}', DE: '\u{1F1E9}\u{1F1EA}', GB: '\u{1F1EC}\u{1F1E7}', CA: '\u{1F1E8}\u{1F1E6}', AU: '\u{1F1E6}\u{1F1FA}', ES: '\u{1F1EA}\u{1F1F8}',
    IT: '\u{1F1EE}\u{1F1F9}', NL: '\u{1F1F3}\u{1F1F1}', SE: '\u{1F1F8}\u{1F1EA}', CH: '\u{1F1E8}\u{1F1ED}', BE: '\u{1F1E7}\u{1F1EA}', IE: '\u{1F1EE}\u{1F1EA}', PT: '\u{1F1F5}\u{1F1F9}',
  };
